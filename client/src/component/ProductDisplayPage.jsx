      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border border-gray-100 prose-description">
              <div
        ...
        <div className="pl-6">
          ...
          {(() => {
            ...
            const specs = fields.filter(f => f !== "brand").map(f => data[f]).filter(Boolean).join(", ")
            return specs
          })() && (
          ...
          {data.brand && (
            <p className="text-base text-gray-600 pb-2"><span className="font-bold">Brand:</span> <span className="font-medium text-blue-600 capitalize">{data.brand}</span></p>
          )}
